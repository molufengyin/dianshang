<template>
  <div class="exchange">    
    <x-header>  <span style="color:#fff;font-size:16px;"> 我的评价 </span>  <a style="color:#999;font-size:16px;" slot="right"><i class="fa fa-search"></i></a>   </x-header>
   <div v-show="orderList.length == 0">
        ...
        <ul>
            <li v-for="(order,index) in orderList">
              ...
              <p class="fot">
                <a v-show="order.checked == 2 && order.isCom == false" :href="'#/comment/' + order._id">去评论</a>
